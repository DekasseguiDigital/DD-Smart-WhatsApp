...
Assert-Contains $main 'Version: 2.2.0-beta.3' 'Main plugin header must be version 2.2.0-beta.3.'
Assert-Contains $main "define('DDSW_VERSION', '2.2.0-beta.3')" 'DDSW_VERSION must be 2.2.0-beta.3.'
